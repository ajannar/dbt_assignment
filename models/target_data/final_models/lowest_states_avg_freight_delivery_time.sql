with orders as (
    select order_id,customer_id,date(order_purchase_timestamp) as order_date,
...
orders_customers as (
    select order_id,o.customer_id,state,order_date,delivery_date 
    from orders o left join customers c on o.customer_id=c.customer_id
),
order_cost as (
    select order_id,sum(freight_value) as total_order_freight
