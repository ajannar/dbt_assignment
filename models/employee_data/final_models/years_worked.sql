...
date_diff(ifnull(end_date,current_date()),start_date,year) as years_worked
 from 
employees left join departments on departments.department_id=employees.department_id
